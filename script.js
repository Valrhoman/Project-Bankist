...
const message = document.createElement('div'); // not yet on the page
...
console.log(message.style.height); // nothing because no height in inline style
...
// to change CSS variables (aka CSS custom properties)
...
// Non-standard
console.log(logo.designer); // only standard properties work
...
const alertH1 = function (e) {
  ...
  // for one time use of the event
  // h1.removeEventListener('mouseenter', alertH1);
};

h1.addEventListener('mouseenter', alertH1);

// for disabling the event handler after 3 sec
...
document.querySelector('.nav__links').addEventListener('click', function (e) {
  this.style.backgroundColor = randomColor(); // demo of bubbling
...
document.querySelector('.nav').addEventListener(
  ...
  //, true
); // true means it will will listen to capturing phase)
...
// Lecture 200: Building a Slider Component
